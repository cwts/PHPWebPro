...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo U('Workhouse/add');?>" class="btn btn-success">添加</a>
        </div>
        <div class="col-md-6">
            <form action="<?php echo U('Workhouse/index');?>" method="post">
                <div class="form-group input-group">
                    <input type="text" class="form-control" name="key" placeholder="输入社工姓名关键词搜索">
    ...
    <table class="table table-hover table-striped table-bordered">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                ...
                <td><?php echo ($v["qualification"]); ?></td>
                <td><?php echo ($v["year"]); ?></td>
             
                <td><a href="<?php echo U('Workhouse/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('Workhouse/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
