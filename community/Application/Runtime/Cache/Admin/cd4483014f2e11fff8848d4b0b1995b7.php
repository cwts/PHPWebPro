...
<div id="page-wrapper">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($member)): foreach($member as $key=>$v): ?><tr>
               ...
               <td><a href="<?php echo U('member/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('member/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
