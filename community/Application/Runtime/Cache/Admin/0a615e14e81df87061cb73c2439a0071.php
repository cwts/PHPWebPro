...
<div id="page-wrapper">
    ...
    <form method="post" action="<?php echo U('Cooperator/add');?>">
    	<div class="form-group">
    ...
    var ue = UE.getEditor('Cooperator-content',{
	 ...
	 $('#selsect').click(function(event) {
			...
			function html5up(file){
				...
				$.ajax({
					url: '<?php echo U("Cooperator/upload",null,false);?>',
					type: 'POST',
			...
			$(document).on('click','.save',function(event){
				...
				// alert(img_url);
				$.ajax({
					url: '<?php echo U("Cooperator/changeName",null,false);?>',
					type: 'POST',
					// dataType: 'default: Intelligent Guess (Other values: xml, json, script, or html)',
...
//						alert(data);return false;
			...
			$(document).on('click', '.glyphicon-trash', function(event) {
			    ...
			    //alert(img_url);
				$.ajax({
					url: '<?php echo U("Cooperator/del",null,false);?>',
					type: 'POST',
					// dataType: 'default: Intelligent Guess (Other values: xml, json, script, or html)',
					data: {url: img_url},
					success:function(data){
