...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('setting/update');?>">
        <div class="form-group">
            <label for="aa">字段名</label>
            <input type="text" name="key" class="form-control" id="aa" value="<?php echo ($model["key"]); ?>" placeholder="key">
        </div>
        <div class="form-group">
            <label for="bb">字段值</label>
            <textarea name="value" id="bb" class="form-control"  cols="30" rows="10" placeholder="value"><?php echo ($model["value"]); ?></textarea>
        </div>
        <div class="form-group">
            <label for="cc">字段描述</label>
            <input type="text" name="description" class="form-control" id="cc" value="<?php echo ($model["description"]); ?>" placeholder="描述信息" >
        </div>
        <div class="form-group">
