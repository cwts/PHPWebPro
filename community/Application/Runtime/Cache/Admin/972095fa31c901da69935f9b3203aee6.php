...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('Recruitment/update');?>">
        <div class="form-group">
            <label for="post-title">招聘信息标题</label>
            <input type="text" name="title" class="form-control" value="<?php echo ($post["title"]); ?>" id="post-title" placeholder="输入招聘信息标题">
        </div>

        <div class="form-group">
            <label for="post-content">招聘信息内容</label>
