...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('News/update');?>">
        <div class="form-group">
            <label for="post-title">新闻标题</label>
            <input type="text" name="title" class="form-control" value="<?php echo ($post["title"]); ?>" id="post-title" placeholder="输入新闻标题">
        </div>

        <div class="form-group">
            <label for="post-content">新闻内容</label>
