...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('Cooperator/update');?>">
        <div class="form-group">
            <label for="Cooperator-title">机构名称</label>
            <input type="text" name="title" class="form-control" value="<?php echo ($post["title"]); ?>" id="Cooperator-title" placeholder="输入机构名称">
        </div>

        <div class="form-group">
            <label for="Cooperator-content">相关内容</label>
            <script id="Cooperator-content" name="content" type="text/plain"><?php echo (htmlspecialchars_decode($post["content"])); ?></script>
           
        </div>
        <div class="form-group row img_box">   
		   <label for="Cooperator-content">机构照片：</label>    
