...
<div id="page_wrapper">
    <form method="post" action="<?php echo U('Publicmap/add');?>">
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="输入信息框标题">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="coordinate" class="form-control" id="coordinate" placeholder="" readonly=”readonly”> <!--readonly=”readonly”-->
        </div>
