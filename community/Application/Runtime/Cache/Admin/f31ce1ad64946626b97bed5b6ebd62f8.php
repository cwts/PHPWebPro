...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('Recommend/update');?>">
        <div class="form-group">
            <label for="Recommend-title">推荐标题</label>
            <input type="text" name="title" class="form-control" value="<?php echo ($post["title"]); ?>" id="Recommend-title" placeholder="输入推荐标题">
        </div>

        <div class="form-group">
            <label for="Recommend-content">推荐内容</label>
            <script id="Recommend-content" name="content" type="text/plain"><?php echo (htmlspecialchars_decode($post["content"])); ?></script>
...
<script type="text/javascript">
    var ue = UE.getEditor('Recommend-content',{
        toolbars: [
