...
<div id="page_wrapper">
    <form method="post" action="<?php echo U('Publicmap/update');?>">
		<input type="hidden" name="id" value="<?php echo ($post["id"]); ?>">
        <div class="form-group">
            <label for="publicmap-title">信息框标题</label>
            <input type="text" name="title" class="form-control" id="title" value="<?php echo ($post["title"]); ?>" placeholder="输入信息框标题">
        </div>
        <div class="form-group">
            <label for="publicmap-content">信息框内容</label>
            <textarea name="content" id="content" class="form-control" rows="3" cols="20" ><?php echo ($post["content"]); ?></textarea>
        </div>
		
        <div class="form-group">
            <label for="publicmap-coordinate">标注点坐标(在地图上点击获取)</label>
            <input type="text" name="coordinate" class="form-control" id="coordinate" value="<?php echo ($post["coordinate"]); ?>" placeholder="" readonly=”readonly”>
        </div>
