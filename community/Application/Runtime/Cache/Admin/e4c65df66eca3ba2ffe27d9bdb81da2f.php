...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('project/add');?>">
        <div class="form-group">
            <label for="project-title">项目标题</label>
            <input type="text" name="title" class="form-control" id="project-title" placeholder="输入项目标题">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <script id="project-content" name="content" type="text/plain"></script>
        </div>   
