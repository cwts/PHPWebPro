...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('Recruitment/add');?>">
        <div class="form-group">
            <label for="recruitment-title">招聘信息标题</label>
            <input type="text" name="title" class="form-control" id="recruitment-title" placeholder="输入招聘信息标题">
        </div>
        <div class="form-group" >
            <label for="recruitment-content">招聘信息内容</label>
            <script id="recruitment-content" name="content" type="text/plain"></script>
        </div>
...
//		});
//	});
    var ue = UE.getEditor('recruitment-content',{
        toolbars: [
