...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo U('Centerdynamic/add');?>" class="btn btn-success">添加动态</a>
        </div>
        <div class="col-md-6">
            <form action="<?php echo U('Centerdynamic/index');?>" method="post">
                <div class="form-group input-group">
                    <input type="text" class="form-control" name="key" placeholder="输入标题、添加人关键词搜索">
    ...
    <table class="table table-hover table-striped table-bordered">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('Centerdynamic/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('Centerdynamic/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
