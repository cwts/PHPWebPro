  ...
  <!-- 屏幕宽度小于768px时，div.navbar-responsive-collapse容器里的内容都会隐藏，显示icon-bar图标，当点击icon-bar图标时，再展开。屏幕大于768px时，默认显示。 -->
	...
	<div class="container" style="margin-top:0px;min-height:550px;background-color:white;">
		<div class="row">
			...
			<div class="col-md-8">
			   <h5 style="margin-top:20px;"><strong>社工之家</strong><small><span class="float_right"><a href="<?php echo U('Index/index');?>">首页</a> > <a href="<?php echo U('CommunityMembers/index');?>">社工之家</a></span></small></h5>
				<hr></hr>         
