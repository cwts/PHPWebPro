...
<html lang="en" class="no-js">
	...
	<!--画廊视图 -->
		...
		<link rel="stylesheet" type="text/css" href="/community/Public/gallery/css/default.css" />
		<link rel="stylesheet" type="text/css" href="/community/Public/gallery/css/component.css" />
		<script src="/community/Public/gallery/js/modernizr.custom.js"></script>
	</head>
	<body>
	...
	<div class="container" style="margin-top:0px;min-height:550px;background-color:white;">
		<div class="row">
			<div class="col-md-3" style="margin-top:20px;margin-left:0px;margin-right:-60px;"> 
				...
				<div style="background-color:#c0153f;height:90px;line-height:90px;color:#ffffff;font-family:黑体;font-size:23px;padding-left:10px;">社工之家</div>
				<div style="background-color:#b95253;height:40px;line-height:40px;color:#ffffff;font-family:黑体;font-size:16px;padding-left:10px;">COMMUNITY MEMBERS</div>
			...
			<div class="col-md-8">
			   <h5 style="margin-top:10px;"><strong>社工之家</strong><small><span class="float_right"><a href="<?php echo U('Index/index');?>">首页</a> > <a href="<?php echo U('CommunityMembers/index');?>">社工之家</a></span></small></h5>
				<hr></hr>   
			<div class="gallery_container" style="margin-top:-23px;">	
			<div id="gr-gallery" class="gr-gallery">
				<div class="gr-main">
				
					 <?php if(is_array($memeberphoto)): foreach($memeberphoto as $e=>$v): ?><figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="<?php echo ($v["photo"]); ?>" alt="img01" />
						</div>
						
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span><?php echo ($v["name"]); ?></span></h4></center>
							<div>
								<p>职务职称：<?php echo ($v["duty"]); ?></p>
								<p>专业方向：<?php echo ($v["major"]); ?></p>
								<p>专业资质：<?php echo ($v["qualification"]); ?></p>
								<p>从业年限：<?php echo ($v["year"]); ?></p>
							</div>
						</figcaption> 
				...
				<!-- 	
				 <figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/11.jpg" alt="img01" />
						</div>
						
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>付芳</span></h4></center>
							<div>
								<p>职务职称：讲师</p>
								<p>专业方向：医务社会、工作儿童、社会工作、精神健康、心理评估与咨询</p>
								<p>专业资质：北京师范大学心理学硕士、香港大学社会工作博士</p>
								<p>从业年限：2年半</p>
							</div>
						</figcaption> 
					</figure>
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/11.jpg" alt="img02" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>方舟</span></h4></center>
							<div>
								<p>职务职称：副主任</p>
								<p>专业方向：宏观社会工作和社会组织</p>
								<p>专业资质：全国社会工作者中级证书</p>
								<p>从业年限：2年</p>
							</div>
						</figcaption>
					</figure>
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/13.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>范冰雁</span></h4></center>
							<div>
								<p>职务职称：项目主管</p>
								<p>专业方向：妇女社会工作和残疾人社会工作</p>
								<p>专业资质：全国社会工作者初级证书</p>
								<p>从业年限：2年</p>
							</div>
						</figcaption>
					</figure>
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/14.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>郭甜</span></h4></center>
							<div>
								<p>职务职称：项目经理</p>
								<p>专业方向：社区社会工作和老年社会工作</p>
								<p>专业资质：全国社会工作者初级证书</p>
								<p>从业年限：1年</p>
							</div>
						</figcaption>
					...
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/15.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>胡晓晴</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：行政管理</p>
								<p>专业资质：人力资源三级</p>
					...
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/16.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>赵明明</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：法律硕士</p>
								<p>专业资质：无</p>
					...
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/11.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>褚怡君</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：社工</p>
								<p>专业资质：无</p>
					...
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/18.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>陆韦华</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：社工</p>
								<p>专业资质：无</p>
					...
					<figure>
						<div style="margin-left:-300px;margin-right:300px;">
							<img src="/community/Public/gallery/images/19.jpg" alt="img03" />
						</div>
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>薛似音</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：日语</p>
								<p>专业资质：日语一级</p>
					...
					<figure>
						...
						<figcaption style="margin-left:-200px;margin-right:200px;">
							<center><h4><span>陈翠华</span></h4></center>
							<div>
								<p>职务职称：社工</p>
								<p>专业方向：无</p>
								<p>专业资质：无</p>
	...
	<div class="container footer footer_style">
       <!-- 底部说明 -->
		...
		<script src="/community/Public/gallery/js/wallgallery.js"></script>
		<script>
			$(function() {
