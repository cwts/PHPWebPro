	...
	<div class="container" style="margin-top:0px;min-height:550px;background-color:white;">
		<div class="row">
			<div class="col-md-3" style="margin-top:20px;margin-left:0px;margin-right:-60px;"> 
				...
				<div style="background-color:#c0153f;height:90px;line-height:90px;color:#ffffff;font-family:黑体;font-size:23px;padding-left:10px;">组织架构</div>
				<div style="background-color:#b95253;height:40px;line-height:40px;color:#ffffff;font-family:黑体;font-size:16px;padding-left:10px;">ORGANIZATION</div>
			...
			<div class="col-md-8">
			   <h5 style="margin-top:20px;"><strong>组织架构</strong><small><span class="float_right"><a href="<?php echo U('Index/index');?>">首页</a> > <a href="<?php echo U('Organization/index');?>">组 织 架 构</a></span></small></h5>
				<hr></hr>         
